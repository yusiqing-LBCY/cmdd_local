...
public class ShopController {
	...
	@ResponseBody
	public ResponseObject getShop(HttpServletRequest request, HttpServletResponse response,@PathVariable("id")int id){
	...
	@ResponseBody
	public ResponseObject updateShop(HttpServletRequest request, HttpServletResponse response, @PathVariable("id") int id, @RequestBody Shop shop){
		/*if(!AuthCheck.UserCheck(request, response,KEYS.AGENT)){
			return null;
		}*/
	...
	@ResponseBody
	public ResponseObject updateShopPayCodeId(HttpServletRequest request, HttpServletResponse response, @PathVariable("id") int id, @RequestBody Shop shop){
	...
	public ResponseObject updateAgentPassword(HttpServletRequest request,
		...
		try{
			int sid = shopService.updateAgentPassword(id, passwordFrom.getOld_password(), passwordFrom.getNew_password());
			map.put("user_id", sid);
