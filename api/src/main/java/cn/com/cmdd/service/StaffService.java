...
public class StaffService {
	...
	@Transactional
	public List<Staff> getStaffListByShop_id(int shop_id){
	...
	@Transactional
	public Integer updateShopPassword(int id,String oldPwd,String newPwd) throws Exception{
