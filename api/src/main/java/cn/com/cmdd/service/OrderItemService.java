...
public class OrderItemService {
	...
	//XXX:
	/*public double getPayable(Integer orderId){
		Double payable1_ = orderItemDao.selectPayable(orderId, 1, 1, 0);
		payable1_ = payable1_==null?0:payable1_;

		Double payable2 = orderItemDao.selectPayable(orderId, 0, 1, 0);
		payable2 = payable2 ==null?0:payable2;

		double sum = DoubleUtil.sum(payable1_, payable2);
		return sum;
	}*/
}
